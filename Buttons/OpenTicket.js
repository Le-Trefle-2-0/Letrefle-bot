...
const checkService = require('../TicketUtility/CheckService');
    ...
    await checkService().then(async () => {
        ...
        return interaction.editReply({
            embeds: [
                new EmbedBuilder()
                    .setColor('E0301E')
                    .setDescription('<:non:913706647187234856> | La permanence est actuellement fermée, veuillez réessayer plus tard.')
            ],
            ephemeral: true
        });
    });
